...
check "1a" "IP Address configured" "ip addr show | grep -q '192.168.1.6/24'"
check "1b" "Gateway configured" "ip route | grep -q '192.168.1.254'"
check "1c" "DNS configured" "grep -q '192.168.1.254' /etc/resolv.conf"
